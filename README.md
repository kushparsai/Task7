...
Displays the user's name, email, and address
...
2. CSS
Styles the user cards.
Makes the layout responsive using grid.
Adds button styling and basic UI improvements.

3. JavaScript (Fetch API)
Fetches data using fetch().
Converts response into JSON.
Loops through users and displays:
